...
- [ ] Any handoff to a downstream skill (`csp-brainstorming`, `csp-spec-driven-development`) was framed in terms of the confirmed intent, not the original underspecified ask
