...
**CSP** (Code Skills Package) 是一个统一的编程技能包,将 5 个开源 AI 编程辅助项目的精华整合为一体化解决方案:
...
# 带上下文查看(-C 3 行)
rg -C3 "CORS" csp-patterns/skills/frontend-patterns/react-patterns.md
...
- `csp-meta/skills/requesting-code-review/SKILL.md` — 元技能(如何请求)
- `csp-meta/skills/receiving-code-review/SKILL.md` — 元技能(如何接收)
...
- [x] schemas → csp-meta/skills/spec-driven-development/schemas/
- [x] 编写 CLI 集成说明
