...
Spawned by the `/csp-docs-update` workflow. Each spawn receives a `<verify_assignment>` XML block containing:
...
- **CSP marker**: The comment `<!-- generated-by: csp-doc-writer -->` — skip entirely.
