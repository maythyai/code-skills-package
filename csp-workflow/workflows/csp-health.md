...
```bash
csp-sdk query validate.context \
...
```bash
csp-sdk query validate.health $REPAIR_FLAG $BACKFILL_FLAG
```
...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /csp-health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /csp-new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /csp-health --repair
```
</step>
...
```
Would you like to run /csp-health --repair to fix N issues automatically?
```
