...
- csp-assumptions-analyzer — Analyzes codebase to surface implementation assumptions
</available_agent_types>
...
AGENT_SKILLS_ANALYZER=$(csp-sdk query agent-skills csp-assumptions-analyzer)
```
...
- When spawning the csp-assumptions-analyzer, pass the lens list so it can flag which lenses apply
...
Spawn a `csp-assumptions-analyzer` agent to deeply analyze the codebase for this phase. This
...
```
Agent(subagent_type="csp-assumptions-analyzer", prompt="""
...
```bash
csp-sdk query commit "docs(${padded_phase}): capture phase context (assumptions mode)" --files "${phase_dir}/${padded_phase}-CONTEXT.md" "${phase_dir}/${padded_phase}-DISCUSSION-LOG.md"
```
...
`/csp-plan-phase ${PHASE}`

---

**Also available:**
- `/csp-plan-phase ${PHASE} --skip-research` — plan without research
- `/csp-ui-phase ${PHASE}` — generate UI design contract (if frontend work)
...
```text
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 CSP ► AUTO-ADVANCING TO PLAN
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Context captured (assumptions mode). Launching plan-phase...
```

Launch: `Skill(skill="csp-plan-phase", args="${PHASE} --auto")`
