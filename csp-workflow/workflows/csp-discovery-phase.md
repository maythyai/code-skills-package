...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /csp-plan-phase --research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/code-skills-package/csp-workflow/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/code-skills-package/csp-workflow/templates/discovery.md structure:
...
**Output:** `.csp/planning/phases/XX-name/DISCOVERY.md`
</step>
...
1. **Scope the discovery** using ~/.claude/code-skills-package/csp-workflow/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/code-skills-package/csp-workflow/templates/discovery.md
...
**Output:** `.csp/planning/phases/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Use ~/.claude/code-skills-package/csp-workflow/templates/discovery.md.
...
Write `.csp/planning/phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .csp/planning/phases/XX-name/DISCOVERY.md
Recommendation: [one-liner]
Confidence: [level]

What's next?

1. Discuss phase context (/csp-discuss-phase [current-phase])
2. Create phase plan (/csp-plan-phase [current-phase])
