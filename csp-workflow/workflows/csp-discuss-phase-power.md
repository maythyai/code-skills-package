...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/csp-discuss-phase`.
...
Consider running /csp-discuss-phase {N} again to refine before planning.
```
