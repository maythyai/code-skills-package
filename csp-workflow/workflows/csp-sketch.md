...
@~/.claude/code-skills-package/csp-workflow/references/sketch-theme-system.md
@~/.claude/code-skills-package/csp-workflow/references/sketch-variant-patterns.md
@~/.claude/code-skills-package/csp-workflow/references/sketch-interactivity.md
@~/.claude/code-skills-package/csp-workflow/references/sketch-tooling.md
</required_reading>
...
**Also available:**
- `/csp-sketch` — sketch more (or run with no argument for frontier mode)
- `/csp-plan-phase` — start building the real UI
- `/csp-spike` — spike technical feasibility of a design pattern
