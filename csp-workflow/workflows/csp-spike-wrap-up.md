...
`.planning/spikes/WRAP-UP-SUMMARY.md`. Companion to `/csp-spike`.
</purpose>
...
```bash
csp-sdk query commit "docs(spike-wrap-up): package [N] spike findings into project skill" --files .planning/spikes/WRAP-UP-SUMMARY.md .planning/spikes/CONVENTIONS.md
```
</step>
