...
for future build conversations. Reads from `.csp/planning/spikes/`, writes skill to
`./.claude/skills/spike-findings-[project]/` (project-local) and summary to
`.csp/planning/spikes/WRAP-UP-SUMMARY.md`. Companion to `/csp-spike`.
</purpose>
...
1. Read `.csp/planning/spikes/MANIFEST.md` for the overall idea context and requirements
2. Glob `.csp/planning/spikes/*/README.md` and parse YAML frontmatter from each
...
```
No unprocessed spikes found in `.csp/planning/spikes/`.
Run `/csp-spike` first to create experiments.
```
Exit.
...
Write `.csp/planning/spikes/WRAP-UP-SUMMARY.md` for project history:
...
Analyze all processed spikes for recurring patterns and write `.csp/planning/spikes/CONVENTIONS.md`. This file tells future spike sessions *how we spike* — the stack, structure, and patterns that have been established.
...
2. Write or update `.csp/planning/spikes/CONVENTIONS.md`:
...
```bash
csp-sdk query commit "docs(spike-wrap-up): package [N] spike findings into project skill" --files .csp/planning/spikes/WRAP-UP-SUMMARY.md .csp/planning/spikes/CONVENTIONS.md
```
</step>
...
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 CSP ► CSPIKE WRAP-UP COMPLETE ✓
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

**Processed:** {N} spikes
**Feature areas:** {list}
**Skill:** `./.claude/skills/spike-findings-[project]/`
**Conventions:** `.csp/planning/spikes/CONVENTIONS.md`
**Summary:** `.csp/planning/spikes/WRAP-UP-SUMMARY.md`
...
`/csp-spike` (run with no argument — its frontier mode analyzes the spike landscape and proposes integration and frontier spikes)

───────────────────────────────────────────────────────────────

**Also available:**
- `/csp-plan-phase` — start planning the real implementation
- `/csp-spike [idea]` — spike a specific new idea
- `/csp-explore` — continue exploring
- Other
...
- [ ] `.csp/planning/spikes/CONVENTIONS.md` created or updated with recurring stack/structure/pattern choices
- [ ] `.csp/planning/spikes/WRAP-UP-SUMMARY.md` written for project history
- [ ] Project CLAUDE.md has auto-load routing line
- [ ] Summary presented
- [ ] Next-step options presented (including frontier spike exploration via `/csp-spike`)
</success_criteria>
