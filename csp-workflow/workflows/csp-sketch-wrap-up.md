...
`/csp-sketch` (run with no argument — its frontier mode analyzes the sketch landscape and proposes consistency and frontier sketches)

───────────────────────────────────────────────────────────────

**Also available:**
- `/csp-plan-phase` — start building the real UI
- `/csp-ui-phase` — generate a UI design contract for a frontend phase
- `/csp-sketch [idea]` — sketch a specific new design area
