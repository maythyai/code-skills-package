...
Offload CSP's plan phase to Claude Code's ultraplan cloud infrastructure.

⚠ **BETA feature.** Ultraplan is in research preview and may change. This workflow is
intentionally isolated from /csp-plan-phase so upstream changes to ultraplan cannot
...
```text
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 CSP ► ULTRAPLAN PHASE  ⚠ BETA
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Ultraplan is in research preview (Claude Code v2.1.91+).
Use /csp-plan-phase for stable local planning.
```
...
/csp-ultraplan-phase requires Claude Code.
ultraplan is not available in this runtime.

Use /csp-plan-phase for local planning instead.
```
...
unplanned phase from the roadmap (same logic as /csp-plan-phase).

Load CSP phase context:
...
Build the ultraplan prompt from CSP context.
...
Produce a CSP PLAN.md with the following YAML frontmatter:
...
When ◆ ultraplan ready appears in your terminal:
  ...
  7. Run: /csp-import --from <the file path>

/csp-import will run conflict detection, convert to CSP format,
