#!/usr/bin/env python3
"""Validate csp-compound docs/solutions/ frontmatter for parser-safety issues.
...
Checks:
    1. File starts and ends frontmatter with `---` lines
    2. No top-level scalar value contains ` #` unquoted (silent comment truncation)
