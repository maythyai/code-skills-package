...
Read and execute `~/.claude/code-skills-package/csp-workflow/workflows/list-phase-assumptions.md` end-to-end.
Stop here.

Otherwise, if `DISCUSS_MODE` is `"assumptions"`:
Read and execute `~/.claude/code-skills-package/csp-workflow/workflows/discuss-phase-assumptions.md` end-to-end.

Otherwise (`"discuss"` / unset / any other value):
Read and execute `~/.claude/code-skills-package/csp-workflow/workflows/discuss-phase.md` end-to-end.
