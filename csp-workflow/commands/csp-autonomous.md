...
<execution_context>
@~/.claude/code-skills-package/csp-workflow/workflows/autonomous.md
...
Project context, phase list, and state are resolved inside the workflow using init commands (`csp-sdk query init.milestone-op`, `csp-sdk query roadmap.analyze`). No upfront context loading needed.
</context>
