...
<execution_context>
@~/.claude/code-skills-package/csp-workflow/workflows/spec-phase.md
@~/.claude/code-skills-package/csp-workflow/templates/spec.md
</execution_context>
...
- User knows they can now run /csp-discuss-phase which will load SPEC.md automatically
</success_criteria>
