---
name: csp-quick
description: Execute a quick task with CSP guarantees (atomic commits, state tracking) but skip optional agents
...
---
<objective>
Execute small, ad-hoc tasks with CSP guarantees (atomic commits, STATE.md tracking).
...
<execution_context>
@~/.claude/code-skills-package/csp-workflow/workflows/quick.md
</execution_context>
...
─────────────────────────────────────
Resume with: /csp-quick resume {slug}
```
