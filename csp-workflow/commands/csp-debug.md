...
**Orchestrator role:** Gather symptoms, spawn csp-debugger agent, handle checkpoints, spawn continuations.
...
<execution_context>
@~/.claude/code-skills-package/csp-workflow/workflows/debug.md
</execution_context>
