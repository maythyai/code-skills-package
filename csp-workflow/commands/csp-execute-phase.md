...
<execution_context>
@~/.claude/code-skills-package/csp-workflow/workflows/execute-phase.md
...
Context files are resolved inside the workflow via `csp-sdk query init.execute-phase` and per-subagent `<files_to_read>` blocks.
</context>
