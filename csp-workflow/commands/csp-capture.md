...
<objective>
Capture ideas, tasks, notes, and seeds to their appropriate destination in the CSP system.
...
<execution_context>
@~/.claude/code-skills-package/csp-workflow/workflows/add-todo.md
@~/.claude/code-skills-package/csp-workflow/workflows/note.md
@~/.claude/code-skills-package/csp-workflow/workflows/add-backlog.md
@~/.claude/code-skills-package/csp-workflow/workflows/plant-seed.md
@~/.claude/code-skills-package/csp-workflow/workflows/check-todos.md
