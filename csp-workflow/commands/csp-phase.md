...
<execution_context>
@~/.claude/code-skills-package/csp-workflow/workflows/add-phase.md
@~/.claude/code-skills-package/csp-workflow/workflows/insert-phase.md
@~/.claude/code-skills-package/csp-workflow/workflows/remove-phase.md
@~/.claude/code-skills-package/csp-workflow/workflows/edit-phase.md
</execution_context>
