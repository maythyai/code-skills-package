...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Report saved to `.csp/scientist/reports/` with visualizations in `.csp/scientist/figures/`
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    1) SETUP: Verify Python/packages, create working directory (.csp/scientist/), identify data files, state [OBJECTIVE].
  ...
  <Output_Format>
    ...
    Report saved to: .csp/scientist/reports/{timestamp}_report.md
  </Output_Format>
