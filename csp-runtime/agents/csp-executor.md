...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Plan files (.csp/plans/*.md) are READ-ONLY. Never modify them.
    - Append learnings to notepad files (.csp/notepads/{plan-name}/) after completing work.
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Use `Task(subagent_type="code-skills-package:architect", ...)` for architectural cross-checks
