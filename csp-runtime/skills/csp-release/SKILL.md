...
Inspect the repo and answer the following. Write answers into `.csp/RELEASE_RULE.md`.
...
### Step 2 — Write `.csp/RELEASE_RULE.md`
...
- `.csp/RELEASE_RULE.md` is a local cache. Commit it to your repo if you want to share the derived rules with your team, or add it to `.gitignore` if you prefer it stays local.
