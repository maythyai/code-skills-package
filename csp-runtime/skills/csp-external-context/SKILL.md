...
```
/code-skills-package:external-context <topic or question>
```

### Examples

```
/code-skills-package:external-context What are the best practices for JWT token rotation in Node.js?
/code-skills-package:external-context Compare Prisma vs Drizzle ORM for PostgreSQL
/code-skills-package:external-context Latest React Server Components patterns and conventions
```
...
```
Task(subagent_type="code-skills-package:document-specialist", model="sonnet", prompt="Search for: <facet 1 description>. Use WebSearch and WebFetch to find official documentation and examples. Cite all sources with URLs.")

Task(subagent_type="code-skills-package:document-specialist", model="sonnet", prompt="Search for: <facet 2 description>. Use WebSearch and WebFetch to find official documentation and examples. Cite all sources with URLs.")
```
