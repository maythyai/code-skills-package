...
PARENT_WATCH_INTERVAL_S = max(
    float(os.environ.get("CSP_PARENT_POLL_INTERVAL_MS", "1000")) / 1000.0, 0.25
)
...
class ExecutionState:
    ...
    def _initialize_namespace(self):
        ...
        # Always restrict JSON-RPC supplied execution; CSP_PYTHON_SANDBOX no
...
def _get_expected_parent_pid() -> Optional[int]:
    ...
    raw_value = os.environ.get("CSP_PARENT_PID")
    if not raw_value:
        return None
