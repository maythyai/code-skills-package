...
if [ ! -d "$PROJECT_ROOT/dist" ] || [ ! -f "$PROJECT_ROOT/dist/index.js" ]; then
    log_error "code-skills-package is not built. Run: npm run build"
    exit 1
fi

log_info "=========================================="
log_info "Running CSP-Enhanced Benchmark"
log_info "=========================================="
log_info "Mode: $RUN_MODE (with code-skills-package orchestration)"
...
log_step "Starting CSP-enhanced benchmark run..."
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    log_info "  2. Compare results: python3 compare_results.py --vanilla predictions/vanilla --csp predictions/csp"
    log_info ""
else
    log_error "=========================================="
