...
- No CSP extensions loaded
- Default system prompt
- Single-agent execution

### CSP Configuration

Code Skills Package enhanced with:
...
Instances that CSP solved but vanilla failed:
...
Instances that vanilla solved but CSP failed:
...
# Install code-skills-package (if testing CSP)
...
```bash
# Generate predictions with CSP
python run_benchmark.py --mode": "csp"/

# Evaluate
python evaluate.py --predictions results/csp/predictions.json --output results/csp/
```
...
```bash
python analyze_failures.py --vanilla results/vanilla/ --csp results/csp/ --compare --output analysis/
```
...
- [Code Skills Package Documentation](../README.md)
