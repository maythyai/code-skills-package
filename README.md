...
**🔗 [Live Interactive Dashboard](https://maythyai.github.io/code-skills-package/)** — explore all 646 skills by layer, category, and triggers
...
| [SKILL-INDEX.md](./docs/SKILL-INDEX.md) | Complete index of 646 skills/agents |
