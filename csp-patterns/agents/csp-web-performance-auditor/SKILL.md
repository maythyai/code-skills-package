---
name: csp-web-performance-auditor
...
| Data Source | Tool | Auth Required |
|-------------|------|---------------|
...
| Live trace, LCP attribution, INP attribution, layout shift attribution | Chrome DevTools MCP server (`performance_*`, `lighthouse_audit`) | `chrome-devtools` MCP server configured in the harness (see `skills/csp-browser-testing-with-devtools`) |
