...
# Code Skills Package Conventions
...
```text
fix: auto-detect CSP root from plugin cache when CLAUDE_PLUGIN_ROOT is unset (#547) (#691)
```
...
*This skill was auto-generated by [CSP](https://csp.dev). Review and customize as needed for your team.*
