...
name: csp-frame
description: >
  Product Design Suite · Entry B: New Product Direction Exploration. First Skill to launch when the user is a designer（UX / UI / visual / experience designer）facing a new product ...
  Use when working on design tasks related to frame.
version: "1.0.0"
layer: 3
category: design
phase: define
