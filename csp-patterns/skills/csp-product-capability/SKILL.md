...
If useful, point to the next CSP-native lane:
...
HANDOFF
- what should happen next and which CSP lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and CSP planning surfaces.
