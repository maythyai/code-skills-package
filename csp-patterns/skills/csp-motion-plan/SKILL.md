---
name: csp-motion-plan
description: >
  Motion design principles and strategy layer. Applies Three Pillars (emotional intent / visual narrative / motion craft) + four Motion Personality archetypes (Playful / Premium /...
  Use when working on design tasks related to motion-plan.
version: "1.0.0"
layer: 3
category: design
phase: build
