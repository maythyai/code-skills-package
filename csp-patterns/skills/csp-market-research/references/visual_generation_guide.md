...
Market research reports should start with **5-6 essential visuals** to establish the analytical framework. Additional visuals can be generated as needed when writing specific sections. This guide provides ready-to-use prompts for the `csp-tech-diagram` and `csp-fal-ai-media` skills.
...
|-------------|------|-----------|
| Charts (bar, line, pie) | csp-tech-diagram | Precise data representation |
| Diagrams (flow, structure) | csp-tech-diagram | Clear technical layouts |
| Matrices (2x2, positioning) | csp-tech-diagram | Strategic frameworks |
| Timelines | csp-tech-diagram | Sequential information |
| Infographics | csp-fal-ai-media | Creative visual synthesis |
| Conceptual illustrations | csp-fal-ai-media | Abstract concepts |
...
**Tool:** csp-tech-diagram

**Purpose:** Foundation visual showing historical and projected market size

**Command:**
```bash
# invoke the csp-tech-diagram skill — schematic prompt: \
...
**Tool:** csp-fal-ai-media

**Purpose:** High-level visual synthesis for cover or executive summary

**Command:**
```bash
# invoke the csp-fal-ai-media skill — image prompt: \
