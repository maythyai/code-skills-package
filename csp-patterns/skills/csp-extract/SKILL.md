...
name: csp-extract
description: >
  Design System Extraction. Tri-mode: ① External — thin wrapper around the designlang CLI; reverse-extract complete design tokens (19 categories) from any live site for /bench / /...
  Use when working on design tasks related to extract.
version: "1.0.0"
layer: 3
category: design
phase: build
