...
The script audits the current working directory by default and auto-detects whether the target is the CSP repo itself or a consumer project using CSP.
...
6. Suggested CSP skills to apply next.
