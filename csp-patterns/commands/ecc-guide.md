---
description: Navigate CSP's current agents, skills, commands, hooks, install profiles, and docs from the live repository surface.
---

# /csp-guide

Use this command as a conversational map of Code Skills Package. It should help the user discover the right CSP surface for their task without dumping the entire README or stale catalog counts.
...
/csp-guide hooks
/csp-guide install
/csp-guide find: <query>
/csp-guide <feature-or-file-name>
```
...
- `scripts/ci/catalog.js --json` for live catalog counts when running inside CSP
...
- `/project-init` for stack-aware CSP onboarding of a target project
