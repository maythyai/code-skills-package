...
Run the instinct CLI, resolving the active CSP plugin root the same way
...
2. Read project instincts from `{CSP_DATA_DIR}/intel/projects/<project-id>/instincts/`
3. Read global instincts from `{CSP_DATA_DIR}/intel/instincts/`
